...
const sources = [
  // --- WordPress sites: usar RSS (mais confiável que HTML scraping) ---
  {
    name: "Saneamento Básico",
    slug: "saneamento-basico",
    url: "https://www.saneamentobasico.com.br",
    feedUrl: "https://www.saneamentobasico.com.br/feed/",
    fetchMethod: "RSS",
    fetchConfig: null,
  },
  {
    ...
    feedUrl: "https://tratabrasil.org.br/feed/",
    fetchMethod: "RSS",
    fetchConfig: null,
  },
  {
    ...
    feedUrl: "https://www.aguaesaneamento.org.br/feed/",
    fetchMethod: "RSS",
    fetchConfig: null,
  },
  {
    ...
    feedUrl: "https://engenharia360.com/feed/",
    fetchMethod: "RSS",
    fetchConfig: null,
  },
  {
  ...
  },
  {
    ...
    feedUrl: "https://www.revistashydro.com.br/feed/",
    fetchMethod: "RSS",
    fetchConfig: null,
  },
  {
    ...
    feedUrl: "https://abes-dn.org.br/feed/",
    fetchMethod: "RSS",
    fetchConfig: null,
  },
  {
    ...
    feedUrl: "https://saneamentohoje.com.br/feed/",
    fetchMethod: "RSS",
    fetchConfig: null,
  },
  {
    ...
    feedUrl: "https://portaldigitalwater.com/feed/",
    fetchMethod: "RSS",
    fetchConfig: null,
  },
  // --- Empresas do setor: HTML scraping (sem RSS padrão) ---
  {
    name: "Aegea",
    slug: "aegea",
    ...
    fetchConfig: JSON.stringify({
      articleListSelector: "article, .noticia-card, .post-item, .card-noticia",
      titleSelector: "h2 a, h3 a, .titulo a, .card-title a",
      summarySelector: ".resumo, .excerpt, .card-text, p",
      imageSelector: "img",
      linkSelector: "h2 a, h3 a, a.read-more, .card-title a",
    }),
  },
  {
    name: "Sabesp",
    ...
    fetchMethod: "HTML_SCRAPE",
    fetchConfig: JSON.stringify({
      articleListSelector: "article, .noticia-item, .news-item, li.item",
      titleSelector: "h2 a, h3 a, .titulo, .titulo a",
      summarySelector: ".resumo, .descricao, p",
      imageSelector: "img",
      linkSelector: "h2 a, h3 a, a.leia-mais, a",
    }),
  },
  {
    name: "Copasa",
    ...
    fetchMethod: "HTML_SCRAPE",
    fetchConfig: JSON.stringify({
      articleListSelector: "article, .noticia-item, .news-item, .ibm-card",
      titleSelector: "h2 a, h3 a, .titulo, .ibm-card__title a",
      summarySelector: ".resumo, p, .ibm-card__content",
      imageSelector: "img",
      linkSelector: "a.ibm-forward-link, h2 a, h3 a, a",
    }),
  },
  {
    name: "Sanepar",
    ...
    fetchMethod: "HTML_SCRAPE",
    fetchConfig: JSON.stringify({
      articleListSelector: "article, .views-row, .node-noticia, .card",
      titleSelector: "h2 a, h3 a, .field-name-title a, .card-title a",
      summarySelector: ".field-name-body p, .views-field-body, .card-text",
      imageSelector: "img",
      linkSelector: "h2 a, h3 a, .card-title a",
    }),
  },
  {
    ...
    fetchMethod: "HTML_SCRAPE",
    fetchConfig: JSON.stringify({
      articleListSelector: "article, .noticia-item, .post-item, .card",
      titleSelector: "h2 a, h3 a, .card-title a",
      summarySelector: ".resumo, .excerpt, .card-text, p",
      imageSelector: "img",
  ...
  },
  {
    ...
    fetchMethod: "HTML_SCRAPE",
    fetchConfig: JSON.stringify({
      articleListSelector: "article, .noticia-item, .tileItem, .summary",
      titleSelector: "h2 a, h3 a, .tileHeadline a",
      summarySelector: ".resumo, .tileBody, p",
      imageSelector: "img",
      linkSelector: "a.summary-url, h2 a, h3 a, a",
    }),
  },
  // --- Fontes governamentais novas ---
  {
    name: "ANA - Agência Nacional de Águas",
    slug: "ana",
    url: "https://www.gov.br/ana",
    scrapeUrl: "https://www.gov.br/ana/pt-br/assuntos/noticias-e-eventos/noticias",
    fetchMethod: "HTML_SCRAPE",
    fetchConfig: JSON.stringify({
      articleListSelector: "article, .tileItem, .summary, .listItem",
      titleSelector: "h2 a, h3 a, .tileHeadline a, .summary-title a",
      summarySelector: ".tileBody, .summary-text, p",
      imageSelector: "img.thumb",
      linkSelector: "a.summary-url, h2 a, h3 a",
    }),
  },
  {
    ...
    scrapeUrl: "https://www.gov.br/cidades/pt-br/assuntos/noticias",
    fetchMethod: "HTML_SCRAPE",
    fetchConfig: JSON.stringify({
      articleListSelector: "article, .tileItem, .summary",
      titleSelector: "h2 a, h3 a, .tileHeadline a, .summary-title a",
      summarySelector: ".tileBody, .summary-text, p",
      imageSelector: "img.thumb",
      linkSelector: "a.summary-url, h2 a, h3 a",
  ...
  },
  {
    name: "FUNASA",
    slug: "funasa",
    url: "https://www.funasa.gov.br",
    scrapeUrl: "https://www.funasa.gov.br/web/guest/noticias",
    fetchMethod: "HTML_SCRAPE",
    fetchConfig: JSON.stringify({
      articleListSelector: "article, .portlet-content li, .journal-content-article",
      titleSelector: "h3 a, h4 a, .asset-title a",
      summarySelector: ".asset-summary p, p",
      imageSelector: "img",
      linkSelector: "h3 a, h4 a, .asset-title a",
    }),
  },
];
...
async function main() {
  ...
  const licitacaoSources = [
    ...
    },
    {
      ...
      fetchMethod: "BEC_SP_SCRAPE",
      fetchConfig: JSON.stringify({
        keywords: ["saneamento", "água", "agua", "esgoto", "drenagem", "resíduos", "residuos", "tubulação", "bomba"],
      }),
      isActive: true,
    },
  ];
